      ...
      <div id="user-search-container">
        <div id="inner">
          ...
          <div id="result-container">
            {this.props.searchResults.userResults.length > 0 ? (
              userResults
            ) : (
              <span id="no-user-message">No users found</span>
            )}
          </div>
          <span id="result-header">Connection Requests</span>
          <div id="result-container">
            {this.props.auth.pnd_connections.length > 0 ? (
              pndConnections
            ) : (
              <span id="no-user-message">No requests</span>
            )}
          </div>
        </div>
      </div>
